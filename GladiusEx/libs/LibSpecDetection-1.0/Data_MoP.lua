...
if GetAccountExpansionLevel() ~= 4 then return end -- not MoP

local addonName, ns = ...

ns.isMoP = true

-- NOTE: The MoP aura mapping is completely incorrect. It is just copy-paste from Cata, and it's not correct.
