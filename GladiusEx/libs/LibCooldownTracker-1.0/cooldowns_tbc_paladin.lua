...
LCT_SpellData[633] = {
  ...
  cooldown_overload = { [SPEC_PALADIN_HOLY] = 2400, },
  cooldown = 3600,
  class = "PALADIN",
}
...
LCT_SpellData[853] = {
  ...
  cooldown = 60,
  cooldown_overload = { [SPEC_PALADIN_HOLY] = 45, [SPEC_PALADIN_RETRIBUTION] = 45, [SPEC_PALADIN_PROTECTION] = 45, },
  class = "PALADIN",
}
...
LCT_SpellData[20271] = {
  ...
  cooldown = 10,
  class = "PALADIN",
  cooldown_overload = { [SPEC_PALADIN_RETRIBUTION] = 8, [SPEC_PALADIN_PROTECTION] = 8, },
}
...
LCT_SpellData[1022] = {
  ...
  class = "PALADIN",
  specID = { SPEC_PALADIN_PROTECTION },
  cooldown_overload = { [SPEC_PALADIN_PROTECTION] = 180, [SPEC_PALADIN_HOLY] = 180, [SPEC_PALADIN_RETRIBUTION] = 180, },
}
